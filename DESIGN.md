...
Auth is a P0 regulatory blocker (`CLAUDE.md §18`) and the first trust impression. All auth screens use
...
Accessibility is verified in the Definition of Done (§27, `CLAUDE.md §19`), not bolted on.
...
The design view of `CLAUDE.md §19`; both must be satisfied. Every page:
...
button, §12) pending the routing migration in `CLAUDE.md §18`.
