...
- Migration `supabase/migrations/060_comm_template_render.sql`
...
- Tests: `tests/email-determinism.test.mjs`, `tests/rls-firewall.test.mjs` (applies 060)
