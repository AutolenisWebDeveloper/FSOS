...
- **P1 · Compliance Intelligence hand-rolled 7-tab tablist** (`ComplianceIntelligence.tsx:1144`) — no `role="tab"`, no keyboard nav; violates "Segmented is the only tab control." → `Segmented mode="tabs"`. ~~FIX-NOW~~ **MOOT (2026-08-28): the component was deleted with the Compliance Intelligence excision (ADR-040).**
