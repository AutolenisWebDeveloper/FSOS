...
// FSA-facing FFS Key Contacts directory. Read-only view of the SAME config-driven
...
export default async function FsaFfsContactsPage() {
  await requireRole('fsa', '/app/contacts/ffs')
  ...
  return (
    <ListShell
      ...
      breadcrumb={[{ label: 'FSA', href: '/app' }, { label: 'Contacts', href: '/app/contacts' }, { label: 'FFS Contacts' }]}
    >
      {body}
    </ListShell>
  )
