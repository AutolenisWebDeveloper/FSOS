    ...
    <SettingsShell title={`Product — ${p.family}`} description="Product configuration. is_security propagates the firewall.">
      <SettingsSection title="Configuration">
        <div className="space-y-1 text-sm">
          ...
          <div className="flex justify-between"><span className="text-muted-foreground">Securities</span><span>{p.is_security ? <Badge variant="blocked">yes — firewall active</Badge> : 'no'}</span></div>
