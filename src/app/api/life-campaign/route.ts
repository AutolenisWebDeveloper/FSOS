...
// Life Conversion Campaign — list campaigns with their operational status + live analytics
// (§15). Read-only; FSA portal (staff/ops/admin/compliance all reach the FSA portal group).
