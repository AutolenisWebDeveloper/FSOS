...
import { applyControl, CONTROL_ROLES } from '@/lib/pipeline-winback/controls'
...
// audit-logged with prev→next state + reason. Only an Active campaign dispatches, so a global
// Disable/Emergency-Stop halts every channel + the enrollment sweep in one place.
