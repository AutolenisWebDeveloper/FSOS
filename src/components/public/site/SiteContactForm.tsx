      ...
      <div className="consent">
        ...
        <div className="consent__row">
          ...
          <label htmlFor="sms-consent">
            ...
            {BUSINESS.brand} at the mobile number provided — including appointment confirmations, reminders, and
            reschedule or cancellation notices, policy and account service updates, document or information requests,
            and replies to my inquiries. Messages originate from {SMS_CONSENT.from}. Msg frequency varies. Msg &amp;
            data rates may apply. Reply STOP to opt out, HELP for help. Consent is not a condition of purchase. See our{' '}
