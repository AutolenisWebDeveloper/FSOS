...
const STEP_LABEL: Record<GateStep, string> = {
  ...
  dnc: 'Do not contact',
  suppression: 'Communications blocked',
...
const STEP_DESCRIPTION: Record<GateStep, string> = {
  ...
  suppression: 'Excluded by agent-level or individual communication suppression (a business exclusion, separate from consent/DNC).',
