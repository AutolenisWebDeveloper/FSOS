-- ─────────────────────────────────────────────────────────────────────────────
-- Migration: 060_fna_data_model  (FNA Overhaul — Slice 2, ADR-016)
--
...
--  import (merged from main) took 051. This is 060 (051/052 were taken by the agency-directory + agency-owner-contact work, and 053–059 by the comms platform, all merged from main).)
--
