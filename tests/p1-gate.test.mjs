...
check('Every agent is green-zone only — no agent holds a "recommend" tool', () => {
  ...
  assert.equal(keys.length, 19, 'full roster present') // +2 social agents (ADR-026): content_drafter, engagement_triager; +1 life_winback (ADR-034)
...
}, () => '19 agents; every tool is green-zone; none can recommend/advise/allocate')
