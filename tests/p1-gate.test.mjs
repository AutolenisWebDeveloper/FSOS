...
check('Every agent is green-zone only — no agent holds a "recommend" tool', () => {
  ...
  assert.equal(keys.length, 18, 'full roster present') // +2 social agents (ADR-026): content_drafter, engagement_triager
...
}, () => '18 agents; every tool is green-zone; none can recommend/advise/allocate')
